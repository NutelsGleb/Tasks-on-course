...
/*в таблице нет пользователей, а есть студенты, но для выполнения задания уровняем эти понятия*/
...
-- 15. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть слово Andrey
 select id, name, created_on from students where created_on='2021-07-12 00:00:00' and name='%Andrey%';

-- 16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8
 select id, name, created_on from students where created_on='2021-07-12 00:00:00' and name='%8%';
